                ...
                <div class="d-flex align-items-center justify-content-center gap-2 mt-2 mt-lg-0">
                    ...
                    <?php if ($usuarioLogado): ?>
                        ...
                        <form action="logout.php" method="POST" class="d-inline">
                            <?php echo campoCsrf(); ?>
                            <button class="btn btn-outline-light rounded-pill px-3 py-1 fw-bold" title="Sair da sessão">Sair</button>
                        </form>
                    <?php else: ?>
            ...
            <div class="row align-items-center gy-4">
                ...
                <div class="col-12 col-lg-7 text-center text-lg-start">
                    ...
                    <h1 class="display-5 fw-bold text-dark mb-3">
                        Bem-vindo à <span class="text-danger texto-marca-farmacerta" style="color: #e63946 !important;">FarmaCerta</span>
                    </h1>
