                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <form method="POST" action="alterarstatus.php" class="d-inline"
                                        onsubmit="return confirm('Deseja alterar o status desta farmácia?')">
                                        <?php echo campoCsrf(); ?>
                                        <input type="hidden" name="id" value="<?php echo (int) $farmacia['id']; ?>">
                                    <button
