...
<main class="container py-4">
    <section class="card card-brand rounded-4 p-4 mb-4" id="cadastrar">
        ...
        <?php if (isset($_GET['ok'])): ?>
            <div class="alert alert-light text-success fw-bold">Funcionário cadastrado!</div>
        <?php endif; ?>
        <form action="cadastrarfuncionario.php" method="POST" id="formCadastro" class="row g-3">
            ...
            <div class="col-12 col-md-6">
                ...
                <input class="form-control" type="text" id="cpf" name="cpf" maxlength="14" placeholder="000.000.000-00" inputmode="numeric" required>
            </div>
            <div class="col-12 col-md-6">
                <label class="form-label fw-bold" for="nascimento">Nascimento</label>
            ...
            <div class="col-12 col-md-6">
                ...
                <input class="form-control" type="text" id="telefone" name="telefone" maxlength="15" placeholder="(00) 00000-0000" inputmode="numeric">
            </div>
            <div class="col-12 col-md-6">
            ...
            <div class="col-12 col-md-6">
                <label class="form-label fw-bold" for="admissao">Admissão</label>
                <input class="form-control" type="date" id="admissao" name="admissao">
            </div>
            <div class="col-12 col-md-6">
                <label class="form-label fw-bold" for="salario">Salário</label>
                <input class="form-control" type="text" id="salario" name="salario" placeholder="R$ 0,00" inputmode="decimal">
            </div>
            <div class="col-12 col-md-6">
                <label class="form-label fw-bold" for="horario">Horário</label>
                <input class="form-control" type="text" id="horario" maxlength="14" placeholder="08:00 às 17:00" autocomplete="off" inputmode="numeric">
                <input type="hidden" id="horarioValor" name="horario">
            </div>
            <div class="col-12 col-md-6">
            ...
            <div class="col-12 col-md-6">
                ...
                <input class="form-control" type="password" id="senha" name="senha" minlength="6" required>
            </div>
            <div class="col-12">
                <button class="btn btn-outline-light rounded-pill fw-bold" type="submit">CADASTRAR</button>
            </div>
        </form>
    </section>
                ...
                <tr>
                    ...
                    <td>
                        <form action="alterarstatus.php" method="POST">
                            ...
                            <button class="btn btn-sm <?= $u['ativo'] ? 'btn-danger' : 'btn-primary' ?> rounded-pill" type="submit">
