...
$sql = 'SELECT * FROM produtos WHERE farmacia_id = ? AND ativo = 1 ORDER BY nome';
    ...
    <body>
                ...
                <table class="tabela" id="tabela-produtos">
                    ...
                    <?php while ($produto = mysqli_fetch_assoc($resultado)) { ?>
                        <tr>
                            ...
                            <td>R$ <?php echo number_format($produto['preco'], 2, ',', '.'); ?>
                            </td>
                            <td>
                                ...
                                <?php } elseif ($produto['quantidade'] <= $produto['estoque_minimo']) { ?>
                                    <br>
                                    <span class="sem-estoque">ESTOQUE BAIXO</span>
                                <?php } ?>
                            </td>
                            <td>
                                <?php echo htmlspecialchars($produto['prateleira']); ?>
                            </td>
                            <td>
                                <details>
        ...
        <script>
            ...
            function confirmarReposicao() {
                var primeiraConfirmacao = confirm('Confirma a reposição?');
