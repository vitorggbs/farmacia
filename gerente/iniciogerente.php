    ...
    <main class="container-xl py-4">
        <section class="row g-3">
            <article class="col-12 col-sm-6 col-xl-3">
                <div class="card h-100 shadow-sm p-3 d-flex flex-row gap-3">
                    <div class="kpi-icone rounded-circle d-flex align-items-center justify-content-center">$</div>
                    <div>
                        <span class="d-block small">Vendas do Dia</span>
                        <strong class="kpi-valor fs-5">R$ <?php echo number_format($resumoDia['total'], 2, ',', '.'); ?></strong>
                        <small class="d-block text-secondary"><?php echo (int) $resumoDia['vendas']; ?> venda(s) realizada(s) hoje</small>
                    </div>
                </div>
            </article>
            <article class="col-12 col-sm-6 col-xl-3">
                <div class="card h-100 shadow-sm p-3 d-flex flex-row gap-3">
                    <div class="kpi-icone rounded-circle d-flex align-items-center justify-content-center">↗</div>
                    <div>
                        <span class="d-block small">Vendas do Mês</span>
                        <strong class="kpi-valor fs-5">R$ <?php echo number_format($resumoMes['total'], 2, ',', '.'); ?></strong>
                        <small class="d-block text-secondary"><?php echo (int) $resumoMes['vendas']; ?> venda(s) neste mês</small>
                    </div>
                </div>
            </article>
            <article class="col-12 col-sm-6 col-xl-3">
                <div class="card h-100 shadow-sm p-3 d-flex flex-row gap-3">
                    <div class="kpi-icone rounded-circle d-flex align-items-center justify-content-center">▤</div>
                    <div>
                        <span class="d-block small">Recibos do Dia</span>
                        <strong class="kpi-valor fs-5"><?php echo (int) $resumoDia['vendas']; ?></strong>
                        <small class="d-block text-secondary">Recibos emitidos hoje</small>
                    </div>
                </div>
            </article>
            <article class="col-12 col-sm-6 col-xl-3">
                <div class="card h-100 shadow-sm p-3 d-flex flex-row gap-3">
                    <div class="kpi-icone rounded-circle d-flex align-items-center justify-content-center">🛒</div>
                    <div>
                        <span class="d-block small">Média por Venda</span>
                        <strong class="kpi-valor fs-5">R$ <?php echo number_format($resumoDia['media'], 2, ',', '.'); ?></strong>
                        <small class="d-block text-secondary">Valor médio por recibo</small>
                    </div>
                </div>
            </article>
        </section>
        ...
        <section class="row g-3 mt-1">
            <article class="col-12 col-xl-7">
                <div class="card h-100 shadow-sm p-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h2 class="h6 fw-bold text-primary mb-0">FATURAMENTO</h2>
                        <span class="badge text-bg-light">Últimos 7 dias</span>
                    </div>
                ...
                <div class="grafico-linha-wrap">
                    ...
                    <div class="d-grid gap-1 text-secondary small text-center" style="grid-template-columns: repeat(7, 1fr);">
            ...
            <article class="col-12 col-xl-5">
                <div class="card h-100 shadow-sm p-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h2 class="h6 fw-bold text-primary mb-0">VENDAS POR CATEGORIA</h2>
                        <span class="badge text-bg-light">Este mês</span>
                    </div>
                        ...
                        <div class="flex-grow-1">
                            <?php foreach ($categorias as $nome => $valor) {
                                ...
                                <div class="d-flex align-items-center gap-2 py-1 small">
                                    <span class="rounded-circle d-inline-block" style="width:11px;height:11px;background:<?php echo $coresCategorias[$nome]; ?>;"></span>
                                    <span class="flex-grow-1"><?php echo $nome; ?></span>
        ...
        <section class="row g-3 mt-1">
            <article class="col-12 col-lg-4">
                <div class="card h-100 shadow-sm p-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h2 class="h6 fw-bold text-primary mb-0">PRODUTOS COM ESTOQUE BAIXO</h2>
                        <a class="btn btn-sm btn-outline-primary" href="produtosgerente.php">Ver todos</a>
                    </div>
                    <?php if (count($estoqueBaixo) == 0) { ?>
                        <p class="text-secondary small text-center mb-0">Nenhum produto com estoque baixo.</p>
                    <?php } ?>
                    <?php foreach ($estoqueBaixo as $produto) {
                        ...
                        $imagem = !empty($produto['imagem']) ? 'uploads/' . ltrim($produto['imagem'], '/') : '../assets/LOGO_2.png'; ?>
                        <div class="d-flex align-items-center gap-2 py-2 border-bottom">
                            <img class="rounded border" src="<?php echo htmlspecialchars($imagem); ?>" alt="" width="36" height="36">
                            <div class="flex-grow-1 min-w-0">
                                <strong class="d-block text-truncate small"><?php echo htmlspecialchars($produto['nome']); ?></strong>
                                <small class="text-secondary">Estoque atual: <?php echo (int) $produto['quantidade']; ?></small>
                                <div class="progress mt-1" style="height:6px;">
                                    <div class="progress-bar" style="width: <?php echo number_format($porcentagem, 0); ?>%;"></div>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
            ...
            <article class="col-12 col-lg-4">
                <div class="card h-100 shadow-sm p-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h2 class="h6 fw-bold text-primary mb-0">ÚLTIMAS VENDAS</h2>
                        <a class="btn btn-sm btn-outline-primary" href="historicorecibogerente.php">Ver todas</a>
                    </div>
                        ...
                        <table class="table table-sm align-middle mb-0">
                            ...
                            <tbody>
                                <?php if (count($ultimasVendas) == 0) { ?>
                                    <tr><td colspan="4" class="text-secondary text-center">Nenhuma venda registrada.</td></tr>
                                <?php } ?>
            ...
            <article class="col-12 col-lg-4">
                <div class="card h-100 shadow-sm p-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h2 class="h6 fw-bold text-primary mb-0">FORMAS DE PAGAMENTO</h2>
                        <span class="badge text-bg-light">Este mês</span>
                    </div>
                    <?php
                    $nomesFormas = array(
                    ...
                    ?>
                        <div class="pagamento-<?php echo $chave; ?> mb-3">
                            <div class="d-flex justify-content-between small">
                                <span><?php echo $nomesFormas[$chave]; ?></span>
                                <strong><?php echo number_format($percentual, 1, ',', '.'); ?>%</strong>
                            </div>
                            <div class="progress my-1" style="height:6px;">
                                <div class="progress-bar" style="width: <?php echo number_format($percentual, 0); ?>%;"></div>
                            </div>
                            <div class="text-end small">R$ <?php echo number_format($valor, 2, ',', '.'); ?></div>
                        </div>
                    <?php } ?>
                </div>
            </article>
        ...
        <section class="dica-estoque rounded-4 p-3 mt-3 d-flex flex-column flex-md-row align-items-md-center gap-3">
            <span class="text-primary fs-3" aria-hidden="true">☼</span>
            <p class="mb-0 flex-grow-1 small">Dica: Acompanhe seus recibos e o estoque para tomar decisões melhores para sua farmácia.</p>
            <a class="btn btn-primary rounded-pill" href="historicorecibogerente.php">VER RELATÓRIOS</a>
        </section>
    </main>
    <?php recursosRodape(); ?>
</body>
