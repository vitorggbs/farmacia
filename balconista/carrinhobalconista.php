...
<html lang="pt-BR">
    ...
    <body>
        ...
        <nav class="menu">
            ...
            <a href="carrinhobalconista.php" class="ativo">
        ...
        <script>
            ...
            function mostrarValorRecebido() {
                ...
                if (forma == "dinheiro") {
                    ...
                    if (forma == "") {
                        ...
                        document.getElementById("valor-mostrado").innerHTML =
            ...
            function calcularTroco() {
                ...
                document.getElementById("valor-mostrado").innerHTML =
                    recebido.toFixed(2).replace(".", ",");

                document.getElementById("troco-mostrado").innerHTML =
