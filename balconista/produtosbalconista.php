...
$resultado = mysqli_query(
    $conexao,
    "SELECT id, nome, preco, quantidade, imagem FROM produtos ORDER BY nome ASC"
);
...
<header class="topo">
    ...
    <div class="usuario-topo">
        ...
        <span>Balconista: <strong id="cpf-balconista"></strong></span>
...
<nav class="menu">
    ...
    <a href="produtosbalconista.php" class="ativo">PRODUTOS</a>
    <a href="carrinhobalconista.php">CARRINHO (<?php echo $quantidadeCarrinho; ?>)</a>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ((int) $produto['quantidade'] <= 0) { ?>
                            <span class="sem-estoque">0<br>SEM ESTOQUE</span>
                        <?php } else { ?>
...
<script>
var cpf = localStorage.getItem("cpfBalconista");

if (cpf === null || cpf === "") {
    window.location.href = "../index.html";
} else {
    document.getElementById("cpf-balconista").innerHTML = cpf;
}

function sair() {
    localStorage.removeItem("cpfBalconista");
    window.location.href = "../index.html";
}
...
function buscarProduto() {
    ...
    for (var i = 1; i < linhas.length; i++) {
        ...
        if (colunaNome) {
            var nome = colunaNome.textContent.toLowerCase();
            linhas[i].style.display = nome.indexOf(busca) > -1 ? "" : "none";
        }
    }
}
</script>
